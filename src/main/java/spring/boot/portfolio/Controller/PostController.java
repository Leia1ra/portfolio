...
public class PostController {
    ...
    public String PostInsertAction(String post_name, String post_content, ArrayList<String> post_category, ArrayList<String> skill_id){
        ArrayList<PostContent> contents = new ArrayList<>();
        contents.add(new PostContent(ContentMode.str, post_content));

        postService.postSave(new PostCollection(post_name, contents, post_category, skill_id));
